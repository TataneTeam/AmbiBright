...
public class Config {
	...
	public enum Parameters {
		CONFIG_LED_NB_TOP, CONFIG_LED_NB_LEFT, CONFIG_SCREEN_DEVICE, CONFIG_ARDUINO_PORT, CONFIG_ARDUINO_DATA_RATE, CONFIG_PROCESS_LIST, CONFIG_RGB_R, CONFIG_RGB_G, CONFIG_RGB_B, CONFIG_CHECK_PROCESS
	}
